...
void serialEvent() {
Serial.println("here"); //this interrupt will trigger when the data coming from the serial monitor(pc/mac/other) is received.
...
void loop() { //the main loop. //if a command was sent to the EZO device.
computerdata[0] = 'r'; //if any other command has been sent we wait only 250ms.
